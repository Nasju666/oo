...
// Fetch categories for authenticated user only
$sql = "SELECT category, COUNT(*) as item_count FROM tblproduct WHERE user_id = ? GROUP BY category";
                ...
                <ul>
                    ...
                    <li class="menu-item">
                        <div class="active">
                            <div class="menu">
                                <div class="menulogo-left">
                                    <img src="../cate.png" alt="" class="light">
                                    Category
                                </div>
                            </div>
                        </div>
            ...
            <div class="sales-report-header">
                ...
                <div class="right-middle">
                    <div class="search-box">
                        ...
                        <input type="text" placeholder="Search.." id="categorySearch" onkeyup="searchCategories()">
                    </div>
    ...
    <script>
        ...
        function searchCategories() {
            ...
            for (let i = 1; i < rows.length; i++) {
                ...
                // Check each cell (category name and item count)
